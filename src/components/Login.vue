        ...
        <div class="mt-4">
            <div>
                <label class="block">
                    ...
                    <input type="email" class="form-input mt-1 block w-full rounded-lg shadow-none outline-none focus:shadow-none focus:outline-none focus:border-blue-500" placeholder="john@example.com" v-model="email">
                </label>
            </div>
            ...
            <div class="mt-3">
                <label class="block">
                    ...
                    <input type="password" class="form-input mt-1 block w-full rounded-lg shadow-none outline-none focus:shadow-none focus:outline-none focus:border-blue-500" placeholder="iamapassword" v-model="password">
                </label>
            </div>

            <div class="mt-6 flex items-center">
                <button :class="loading ? 'opacity-75 cursor-not-allowed' : ''" class="rounded-lg px-4 py-2 bg-blue-500 hover:bg-blue-600 text-sm font-medium text-white leading-relaxed shadow-md" @click="auth.signInAnonymously()" :disabled="loading ? true : false" >
